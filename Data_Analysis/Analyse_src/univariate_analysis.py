...
# Abstract Base Class for Univariate Analsis strategy
# ---------------------------------------------------
class UnivariateAnalysisStrategy(ABC):
    ...
    def analyze(self, df: pd.DataFrame, feature:str):
        ...
        feature(str): The name of the feature/coloumn to be analyzed.
...
# ----------------------------------------------------
# This class allows you to switch between different univariate strategies
...
if __name__ == "__main__":
    ...
    # analyzer.set_strategy(CategoricalUnivariate())
