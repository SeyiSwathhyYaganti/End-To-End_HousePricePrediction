...
if __name__ == "__main__":
    # df= pd.read_csv("/Users/swathhy/Downloads/MASTERS 1st sem'/Resume projects/End-To-End_HousePricePrediction/extracted data/AmesHousing.csv")

    # missing_values = SimpleMissingValueAnalysis()
