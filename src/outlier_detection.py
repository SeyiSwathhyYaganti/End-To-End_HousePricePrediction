...
class OutlierDetector:
    ...
    def set_strategy(self, strategy:OutlierDetectionStrategy):
        logging.info("Switching outlier detection")
        self._strategy = strategy
    ...
    def visualize_outliers(self, df:pd.DataFrame, features:list):
        logging_info(f"Visualizing outliers for features:{features}")
...
if __name__ == "__main__":
    ...
    # Iniatilize the outlier detector with the z-score based outlier
